...
SRCS := main.c prussdrv.c adcdriver_host.c spidriver_host.c svd.c matrixmul.c subf.c xnorm.c
OBJS := main.o prussdrv.o adcdriver_host.o spidriver_host.o svd.o matrixmul.o subf.o xnorm.o
EXES := main
INCLUDEDIR := ./include
...
main.o: $(SRCS) /usr/include/fftw3.h svd.h matrixmul.h subf.h 
